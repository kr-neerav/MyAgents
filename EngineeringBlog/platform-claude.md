# Engineering Blog Agent — Claude Setup Guide

This guide walks you through deploying the Engineering Blog Agent on Claude. The core prompt lives in `engineering-blog-agent-prompt.md` — this file only covers platform-specific setup.
